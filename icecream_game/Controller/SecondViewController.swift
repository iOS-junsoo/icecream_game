...
class SecondViewController: UIViewController {
    ...
    var whichStick4 = 0
    var money = 0
    var level:Level = Level(progress: 0.0333, targetMoney: 2000)
    var countKids = 1
    var freezeCount1 = 0
    var freezeCount2 = 0
    var freezeCount3 = 0
                ...
                DispatchQueue.main.async {
                   ...
                   // print(self.money)
                    ...
                    if self.money >= self.level.targetMoney {
                        ...
                        self.money = 0
                        if let vc = self.storyboard?.instantiateViewController(withIdentifier: "finishViewController") as? finishViewController {
